...
namespace EightAID.EIGHTAIDLib.Editor
{
    public static class SimpleSliderCreator
    {
        ...
        public static void Create(MenuCommand menuCommand)
        {
            ...
            raycastImage.sprite = defaultSprite;
            raycastImage.color = new Color(1f, 1f, 1f, 0f);
            raycastImage.raycastTarget = true;

            GameObject background = CreateImageChild(root.transform, "Background", defaultSprite, new Color(0.22f, 0.22f, 0.22f, 1f));
            ...
            GameObject fill = CreateImageChild(root.transform, "Fill", defaultSprite, new Color(0.92f, 0.76f, 0.28f, 1f));
            ...
            GameObject handle = CreateImageChild(root.transform, "Handle", defaultSprite, Color.white);
        ...
        private static GameObject CreateImageChild(Transform parent, string name, Sprite sprite, Color color)
        {
            ...
            image.sprite = sprite;
            image.color = color;
            image.raycastTarget = name == "Handle";
